var MojControls = {
    ...
    ComboBox: {
        clearComboBox: function (combobox, isEnabled) {
            ...
            comboBoxInput.enable(isEnabled);
        },
    },
    ...
    AutoComplete: {
        ...
        setDataSource: function (autoCompleteId, dataSoruce) {
            ...
            dataSoruce = Moj.HtmlHelpers._getFilteredActiveData(dataSoruce, MojFind("#" + autoCompleteId).attr('originalIndex'), autoComplete);
        ...
        setValueById: function (autoCompleteId, value) {
            MojFind("#" + autoCompleteId).data("kendoComboBox").dataSource.filter([]);
    ...
    DropDown: {
        ...
        setDataSourceAndValue: function (dropDownId, dataSoruce, value) {
            ...
            dataSoruce = Moj.HtmlHelpers._getFilteredActiveData(dataSoruce, MojFind("#" + dropDownId).attr('originalIndex'), dropDown);
        ...
        setDataSourceByDropDown: function (selector, dataSoruce) {
            ...
            dataSoruce = Moj.HtmlHelpers._getFilteredActiveData(dataSoruce, selector.attr('originalIndex'), dropDown);
            dropDown.setDataSource(dataSoruce);
            dropDown.refresh();
        },
