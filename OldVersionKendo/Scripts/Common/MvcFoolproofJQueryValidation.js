...
foolproof.is = function (value1, operator, value2, passOnNull) {
    ...
    var isDate = function (input) {
        ...
        var dateTest = new RegExp(/^$|(?!3[2-9]|00|02-3[01]|04-31|06-31|09-31|11-31)[0-3][0-9]\/(?!1[3-9]|00)[01][0-9]\/\d{4}/);
        if (input == '')
            return false;
    ...
    if (isDate(value1)) {
        value1 = kendo.parseDate(value1, ["hh:mm dd/MM/yyyy", "dd/MM/yyyy"]);
        value2 = kendo.parseDate(value2, ["hh:mm dd/MM/yyyy", "dd/MM/yyyy"]);
    }
...
jQuery.validator.addMethod("is", function (value, element, params) {
    ...
    var dependentValue = MojFind("[id='" + dependentProperty + "']").val();
...
jQuery.validator.addMethod("requiredif", function (value, element, params) {
    ...
    var dependentPropertyElement = MojFind("[name='" + dependentProperty + "']");
