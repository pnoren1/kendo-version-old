// Version:     l3ny 1.0.4  = Jquery latest, JqueryUI 1.8.14, jquery.validate/1.8.2, jquery-1.6.2-vsdoc.js, jquery Mobile latest.
// Name:        start.debug.js
...
return this.each(function() { \
    ...
    loader.defineScripts(null, [
     { name: "jQuery",
       releaseUrl: "http://code.jquery.com/jquery-latest.min.js",
       debugUrl: "http://code.jquery.com/jquery-latest.js",
       isLoaded: !!window.jQuery
     },
     { name: "jQueryUI",
         releaseUrl: ajaxPath + "jquery.ui/1.8.14/jquery-ui.min.js",
         debugUrl: ajaxPath + "jquery.ui/1.8.14/jquery-ui.js",
         dependencies: ["jQuery"],
         isLoaded: !!(window.jQuery && jQuery.fn.validate)
     },
     { name: "jQueryMobile",
         releaseUrl: "http://code.jquery.com/mobile/latest/jquery.mobile.min.js",
         debugUrl: "http://code.jquery.com/mobile/latest/jquery.mobile.js",
//         releaseUrl: "http://code.jquery.com/mobile/1.0a2/jquery.mobile-1.0a2.min.js",
//         debugUrl: "http://code.jquery.com/mobile/1.0a2/jquery.mobile-1.0a2.js",
         dependencies: ["jQuery"],
         isLoaded: !!(window.jQuery && jQuery.fn.validate)
     },
     { name: "jQueryValidate",
       releaseUrl: ajaxPath + "jquery.validate/1.8.1/jquery.validate.min.js",
       debugUrl: ajaxPath + "jquery.validate/1.8.1/jquery.validate.js",
       dependencies: ["jQuery"],
       isLoaded: !!(window.jQuery && jQuery.fn.validate)
     }
    ]);
...
//    a.setAttribute('href', 'http://code.jquery.com/mobile/latest/jquery.mobile.css')
